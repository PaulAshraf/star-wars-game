...
//
//vector<double> bulletXSuper;
//vector<double> bulletYSuper;
//vector<double> bulletZSuper;
//
//int health = 100;
//int score = 0;
//
...
//
//void hitSuper() {
//	for (int i = 0; i < bulletXSuper.size(); i++) {
//
//
//		if (bulletXSuper[i] > sphere1X - sphere1Radius && bulletXSuper[i] < sphere1X + sphere1Radius &&
//			bulletYSuper[i] > sphere1Y - sphere1Radius && bulletYSuper[i] < sphere1Y + sphere1Radius &&
//			bulletZSuper[i] > sphere1Z - sphere1Radius && bulletZSuper[i] < sphere1Z + sphere1Radius) {
//			hit1 = true;
//			score += 20;
//			bulletXSuper.erase(bulletXSuper.begin() + i);
//			bulletYSuper.erase(bulletYSuper.begin() + i);
//			bulletZSuper.erase(bulletZSuper.begin() + i);
//			if (bulletXSuper.size() != 0)
//				i--;
//			return;
//		}
//		if (bulletXSuper[i] > sphere2X - sphere2Radius && bulletXSuper[i] < sphere2X + sphere2Radius &&
//			bulletYSuper[i] > sphere2Y - sphere2Radius && bulletYSuper[i] < sphere2Y + sphere2Radius &&
//			bulletZSuper[i] > sphere2Z - sphere2Radius && bulletZSuper[i] < sphere2Z + sphere2Radius) {
//			hit2 = true;
//			score += 20;
//			bulletXSuper.erase(bulletXSuper.begin() + i);
//			bulletYSuper.erase(bulletYSuper.begin() + i);
...
//			return;
//		}
//		if (bulletXSuper[i] > sphere3X - sphere3Radius && bulletXSuper[i] < sphere3X + sphere3Radius &&
//			bulletYSuper[i] > sphere3Y - sphere3Radius && bulletYSuper[i] < sphere3Y + sphere3Radius &&
//			bulletZSuper[i] > sphere3Z - sphere3Radius && bulletZSuper[i] < sphere3Z + sphere3Radius) {
//			hit3 = true;
//			score += 20;
//			bulletXSuper.erase(bulletXSuper.begin() + i);
//			bulletYSuper.erase(bulletYSuper.begin() + i);
...
//			return;
//		}
//		if (bulletXSuper[i] > sphere4X - sphere4Radius && bulletXSuper[i] < sphere4X + sphere4Radius &&
//			bulletYSuper[i] > sphere4Y - sphere4Radius && bulletYSuper[i] < sphere4Y + sphere4Radius &&
//			bulletZSuper[i] > sphere4Z - sphere4Radius && bulletZSuper[i] < sphere4Z + sphere4Radius) {
//			hit4 = true;
//			score += 20;
//			bulletXSuper.erase(bulletXSuper.begin() + i);
//			bulletYSuper.erase(bulletYSuper.begin() + i);
...
//			return;
//		}
//		if (bulletXSuper[i] > sphere5X - sphere5Radius && bulletXSuper[i] < sphere5X + sphere5Radius &&
//			bulletYSuper[i] > sphere5Y - sphere5Radius && bulletYSuper[i] < sphere5Y + sphere5Radius &&
//			bulletZSuper[i] > sphere5Z - sphere5Radius && bulletZSuper[i] < sphere5Z + sphere5Radius) {
//			hit5 = true;
//			score += 20;
//			bulletXSuper.erase(bulletXSuper.begin() + i);
//			bulletYSuper.erase(bulletYSuper.begin() + i);
...
//
//	bulletXSuper.push_back(currX - 2.5);
//	bulletXSuper.push_back(currX + 2.5);
//	
//	
//	bulletYSuper.push_back(currY + 1.2);
//	bulletYSuper.push_back(currY - 1.2);
//
//		if (moveLeft) {
//			bulletYSuper.push_back(currY - 1.2);
...
//		}
//		else {
//			bulletYSuper.push_back(currY);
//			bulletYSuper.push_back(currY);
//		}
//	
//	bulletZSuper.push_back(currZ);
//	bulletZSuper.push_back(currZ);
//
//
//	
...
//		bulletZ[i] -= 0.5;
//	}
//	for (int i = 0; i < bulletZSuper.size(); i++) {
//		bulletZSuper[i] -= 0.5;
//	}
//	if (score >= 200 && level0) {
//		level0 = false;
...
//
//	/*if (bulletX.size() > 50) {
//		bulletX.erase(bulletX.begin() + bulletX.size() - 1);
//		bulletY.erase(bulletY.begin() + bulletY.size() - 1);
//		bulletZ.erase(bulletZ.begin() + bulletZ.size() - 1);
//	}*/
//
//
//	collision();
...
//		qobj = gluNewQuadric();
//
//		glTranslated(bulletXSuper[i], bulletYSuper[i], bulletZSuper[i]);
//		glBindTexture(GL_TEXTURE_2D, tex2);
//		gluQuadricTexture(qobj, true);
//		gluQuadricNormals(qobj, GL_SMOOTH);
//		gluCylinder(qobj, 0.1f, 0.1f, 5, 32, 32);
//		gluDeleteQuadric(qobj);
//
//		glPopMatrix();
//
